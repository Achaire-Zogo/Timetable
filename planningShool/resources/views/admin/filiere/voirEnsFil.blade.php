            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach($ens as $e)
                        <tr>
                            <td>{{$e->titre}} {{$e->nom_enseignant}} {{$e->prenom_enseignant}}</td>
                            <td>
                          
                                <a class="btn btn-outline-danger" href="{{ route('delEnsFil', ['id'=>$e->id_EF]) }}" title="edit">
